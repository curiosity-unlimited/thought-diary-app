...
4. Check all branches and make sure `develop` is in the list:
    ```bash
    git branch -a
    ```
...
6. Create a new branch, `practice` for example, for your own work:
    ```bash
...
8. Merge feature branches to `practice`:
    ```bash
